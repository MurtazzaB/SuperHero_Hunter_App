...
const showCorrespondingHeros = () => {
  ...
  function connection() {
    ...
    // INCASE OF LOAD END
        ...
        xhr.open("GET", `http://gateway.marvel.com/v1/public/characters?${params}&ts=1&apikey=fd926028b0eb5102d466d518b1d0365c&hash=7639dfad073f7d692b4f2ad2f46bf184`, true);
  ...
  function comics(characterID) {
    ...
    // ON ERROR
      ...
      xhr.open("GET", `http://gateway.marvel.com/v1/public/characters/${id}/comics?ts=1&apikey=fd926028b0eb5102d466d518b1d0365c&hash=7639dfad073f7d692b4f2ad2f46bf184`, true);
